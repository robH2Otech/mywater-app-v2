...
export function ImpactAchievements({ bottlesSaved }: ImpactAchievementsProps) {
  // Define achievement levels
  const achievements = [
    { threshold: 100, label: "100+ Bottles", gradient: "from-blue-500 to-cyan-500", earned: bottlesSaved >= 100 },
    { threshold: 500, label: "500+ Bottles", gradient: "from-green-500 to-emerald-500", earned: bottlesSaved >= 500 },
    { threshold: 1000, label: "1000+ Bottles", gradient: "from-purple-500 to-pink-500", earned: bottlesSaved >= 1000 }
  ];

  // Filter earned achievements
  const earnedAchievements = achievements.filter(badge => badge.earned);

  // If no badges earned yet, show progress
