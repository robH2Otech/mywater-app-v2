      ...
      >
        <motion.div variants={item}>
          <ImpactCard
            ...
            icon={Waves}
            className="bg-gradient-to-br from-blue-500/30 to-cyan-500/30 border-blue-400/30"
        ...
        <motion.div variants={item}>
          <ImpactCard
            ...
            icon={Coins}
            className="bg-gradient-to-br from-amber-500/30 to-orange-500/30 border-amber-400/30"
        ...
        <motion.div variants={item}>
          <ImpactCard
            ...
            value="CO₂ Reduced"
            icon={Leaf}
            className="bg-gradient-to-br from-emerald-500/30 to-green-500/30 border-emerald-400/30"
        ...
        <motion.div variants={item}>
          <ImpactCard
            ...
            value="Plastic Saved"
            icon={Recycle}
            className="bg-gradient-to-br from-green-500/30 to-lime-500/30 border-green-400/30"
