  ...
  const [socialPosts, setSocialPosts] = useState<Notification[]>([
    {
      id: "s1",
      title: "Instagram",
      content: "Visit our website to learn more about our water purification technology! #CleanWater #Innovation",
      icon: <Instagram className="h-4 w-4 text-pink-500" />,
      time: "1 day ago",
      read: false,
      link: "http://www.x-water.eu",
      platform: 'instagram',
      type: 'social'
    },
    {
      id: "s2",
      title: "Facebook",
      content: "Join our community and learn about sustainable water usage at our website!",
    ...
    },
    {
      id: "s3",
      title: "LinkedIn",
      content: "X-WATER announces new sustainability initiatives. Check our website for details.",
