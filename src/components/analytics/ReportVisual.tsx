...
import { generateVisualPDF } from "@/utils/pdfUtils";
...
export function ReportVisual({ unit, reportType, metrics }: ReportVisualProps) {
  ...
  const handleGeneratePDF = async () => {
    try {
      const success = await generateVisualPDF(unit, reportType, metrics);
...
// Helper function to get date range based on report type - duplicated for component independence
